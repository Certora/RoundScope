...
abstract contract Fixture is InfiniFiTest {
    ...
    YieldSharingV2 public yieldSharing;
    ...
    InfiniFiGatewayV2 public gateway;
    ...
    function setUp() public virtual {
        ...
        yieldSharing = new YieldSharingV2(
        ...
        address gatewayImplementation = address(new InfiniFiGatewayV2());
        gateway = InfiniFiGatewayV2(
            address(
                new TransparentUpgradeableProxy(
                    gatewayImplementation,
                    address(longTimelock),
                    abi.encodeWithSelector(InfiniFiGatewayV2.init.selector, address(core))
                )
            )
        );
