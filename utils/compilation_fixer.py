...
Ported from certora-autosetup's fixconf / CompilationWorkaroundManager, simplified
for the single-file-at-a-time roundabout use case (flat config keys, no per-contract maps).
"""
